...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden max-w-2xl">
    ...
    <div class="p-8 pl-10">
        <form action="{{ route('insumos.store') }}" method="POST">
            ...
            <div class="mb-6">
                <label for="estoque_atual" class="block text-sm font-medium text-gray-700 mb-2">Estoque Inicial</label>
                <input type="number" step="0.01" name="estoque_atual" id="estoque_atual" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-blue-500 focus:border-blue-500 px-4 py-3 transition-colors outline-none" placeholder="Ex: 50" required oninvalid="this.setCustomValidity('Por favor, digite um valor numérico para a quantidade.')" oninput="this.setCustomValidity('')">
            </div>
