...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Editar Lançamento Financeiro</h2>
        ...
        <form action="{{ route('lancamentos-financeiros.update', $lancamento->id) }}" method="POST">
            ...
            <div class="flex flex-col md:flex-row gap-5 mb-5">
                ...
                <div class="flex-1">
                    ...
                    <input type="date" name="data_lancamento" id="data_lancamento" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-blue-500 focus:border-blue-500 px-4 py-3 transition-colors outline-none @error('data_lancamento') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" value="{{ $lancamento->data_lancamento }}" required>
