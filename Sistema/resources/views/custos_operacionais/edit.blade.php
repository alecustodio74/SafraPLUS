...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Editar Custo Operacional</h2>
    ...
    <div class="p-8 pl-10">
        <form action="{{ route('custos-operacionais.update', $custo->id) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="descricao" id="descricao" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-rose-500 focus:border-rose-500 px-4 py-3 transition-colors outline-none" value="{{ $custo->descricao }}" required placeholder="Ex: Combustível, Manutenção">
            </div>
