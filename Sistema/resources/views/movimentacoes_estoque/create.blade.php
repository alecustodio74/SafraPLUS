...
@section('header_title', 'Nova Movimentação de Estoque')

@section('content')
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Registrar Movimentação de Estoque</h2>
        <p class="text-sm text-gray-500 mt-1">Insira os dados da movimentação a ser realizada.</p>
    </div>
</div>
    ...
    <div class="p-8 pl-10">
        <form action="{{ route('movimentacoes-estoque.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <select name="tipo_movimentacao" id="tipo_movimentacao" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-teal-500 focus:border-teal-500 px-4 py-3 transition-colors outline-none @error('tipo_movimentacao') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" required>
            ...
            <div class="mb-5">
                ...
                <select name="insumo_id" id="insumo_id" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-teal-500 focus:border-teal-500 px-4 py-3 transition-colors outline-none @error('insumo_id') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" required>
            ...
            <div class="flex flex-col md:flex-row gap-5 mb-5">
                <div class="flex-1">
                    ...
                    <input type="number" step="0.01" name="quantidade" id="quantidade" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-teal-500 focus:border-teal-500 px-4 py-3 transition-colors outline-none @error('quantidade') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" value="{{ old('quantidade') }}" required placeholder="Ex: 75">
                    @error('quantidade')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex-1">
                    ...
                    <input type="date" name="data_movimentacao" id="data_movimentacao" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-teal-500 focus:border-teal-500 px-4 py-3 transition-colors outline-none @error('data_movimentacao') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" value="{{ old('data_movimentacao', date('Y-m-d')) }}" required>
            ...
            <div class="mb-6" id="safra_id_wrapper" style="display: none;">
                <label for="safra_id" class="block text-sm font-medium text-gray-700 mb-2">Safra de Destino</label>
                <select name="safra_id" id="safra_id" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-teal-500 focus:border-teal-500 px-4 py-3 transition-colors outline-none @error('safra_id') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">
