...
@section('header_title', 'Nova Mão de Obra')
    ...
    <div class="p-8 pl-10">
        <form action="{{ route('mao-de-obra.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nome_ou_tipo" id="nome_ou_tipo" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 px-4 py-3 transition-colors outline-none" placeholder="Diarista / Tratorista" required>
            </div>

            <div class="mb-6">
                <label for="custo_diario_hora" class="block text-sm font-medium text-gray-700 mb-2">Custo (Diário/Hora)</label>
                <input type="number" step="0.01" name="custo_diario_hora" id="custo_diario_hora" class="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 px-4 py-3 transition-colors outline-none" placeholder="Ex: 150,00">
            </div>
