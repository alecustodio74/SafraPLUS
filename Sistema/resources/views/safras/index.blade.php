...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Gerenciamento de Safras</h2>
        <p class="text-sm text-gray-500 mt-1">Acompanhe as suas culturas e os resultados do plantio.</p>
    </div>
