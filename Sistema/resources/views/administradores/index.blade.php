...
<div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Gerenciamento de Administradores</h2>
        <p class="text-sm text-gray-500 mt-1">Gerencie os usuários com permissão total de acesso ao sistema.</p>
    </div>
