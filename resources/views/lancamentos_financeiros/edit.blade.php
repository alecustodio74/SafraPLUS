                ...
                <div class="card-body">
                    <form action="{{ route('lancamentos-financeiros.update', $lancamento->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="descricao" id="descricao" class="form-control @error('descricao') is-invalid @enderror" value="{{ $lancamento->descricao }}" required placeholder="Semente de Milho">
                            @error('descricao')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="valor_total" id="valor_total" class="form-control @error('valor_total') is-invalid @enderror" value="{{ $lancamento->valor_total }}" required placeholder="R$ 2500,00">
                            @error('valor_total')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="data_lancamento" id="data_lancamento" class="form-control @error('data_lancamento') is-invalid @enderror" value="{{ $lancamento->data_lancamento }}" required>
