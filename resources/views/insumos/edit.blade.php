                ...
                <div class="card-body">
                    <form action="{{ route('insumos.update', $insumo->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control" value="{{ $insumo->nome }}" required placeholder="Semente de Soja / Fertilizante NPK">
                        </div>

                        <div class="mb-3">
                            <label for="estoque_atual" class="form-label">Estoque Atual</label>
                            <input type="number" step="0.01" name="estoque_atual" id="estoque_atual" class="form-control" value="{{ $insumo->estoque_atual }}" placeholder="50">
                        </div>
